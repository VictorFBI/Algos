...
std::ofstream fout_abs(R"(C:\Users\frolo\CLionProjects\assemblyTestProgram\abs_random_quick.txt)");
std::ofstream fout_rev(R"(C:\Users\frolo\CLionProjects\assemblyTestProgram\reversed_quick.txt)");
std::ofstream fout_sor(R"(C:\Users\frolo\CLionProjects\assemblyTestProgram\alm_sorted_quick.txt)");
...
int main() {
  ...
  fout_abs.open(R"(C:\Users\frolo\CLionProjects\assemblyTestProgram\abs_random_hybrid50.txt)");
  fout_rev.open(R"(C:\Users\frolo\CLionProjects\assemblyTestProgram\reversed_hybrid50.txt)");
  fout_sor.open(R"(C:\Users\frolo\CLionProjects\assemblyTestProgram\alm_sorted_hybrid50.txt)");
